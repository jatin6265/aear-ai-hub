...
const LEGAL_CONTENT: Record<string, { title: string; body: string[] }> = {
  terms: {
    ...
    body: [
      "OpsAI provides an enterprise AI operating layer for governed data and action workflows.",
  ...
  privacy: {
    ...
    body: [
      "OpsAI processes tenant-isolated metadata, usage telemetry, and configured connection payloads to provide product functionality.",
  ...
  security: {
    title: "Security",
    body: [
      "OpsAI uses Supabase auth, row-level security, and governed execution policies to protect tenant boundaries.",
